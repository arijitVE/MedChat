...
def chunk_text(pages: Union[List[Dict[str, Any]], str]) -> List[Dict[str, Any]]:
    """
    Chunks extracted pages using RecursiveCharacterTextSplitter.
    `pages` is either a string or a list of dicts: {"page_no": int, "text": str}
    ...
    for chunk in raw_chunks:
        ...
        search_start = start_idx + len(chunk) - 200

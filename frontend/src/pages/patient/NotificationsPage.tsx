...
export default function NotificationsPage() {
  ...
  const markRead = useMarkNotificationRead('patient');
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-clinical-text-secondary">Report updates, doctor review updates, and system alerts.</p>
      </div>
